...
//    添加电影
    ...
    public List<Movie> addMovie(){
       movieMapper.addMovie(new Movie(2,"与神同行","金容华",156,"阴间有法，所有亡者在死后的49天内都要经过七次审判——分别在杀人狱、懒惰狱、欺骗狱、不义狱、背叛狱、暴力狱、天伦狱中进行，只有通过了七次审判宣告无罪的亡者，才有获得新生的机会。","kho","河正宇、车太贤、朱智勋、金香奇 、金东旭、都敬秀"));
